    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='pythonclubapp.Product')),
        ...
        migrations.AddField(
            model_name='product',
            name='pythontype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='pythonclubapp.PythonType'),
        ),
        migrations.AddField(
            model_name='product',
            name='user',
